...
import day13_arrays.C06_Arreys;
...
public class C05_BinarySearch {
    public static void main(String[] args) {
        ...
        Arrays.sort(isimler);
        System.out.println(Arrays.toString(isimler));//[Azim, Esra, Huseyin, Ibrahim, Omer]
        ...
        System.out.println(Arrays.binarySearch(isimler,"Azim"));//08
        System.out.println(Arrays.binarySearch(isimler,"Omer"));//4
