...
public class C02_ArraysaElemanEkleme {
    public static void main(String[] args) {
        ...
        System.out.println("arr1'in son method colldan sonraki h hali:"+ Arrays.toString(arr1));//[4, 5, 6, 7, 8, 10]

        arr1=arrayeElemanEkle(arr1,12);

        System.out.println("arr1'in son 2. method colldan sonraki h hali:"+ Arrays.toString(arr1));//[4, 5, 6, 7, 8, 10, 12]
