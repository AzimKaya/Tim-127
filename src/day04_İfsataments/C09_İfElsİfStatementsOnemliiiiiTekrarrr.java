...
public class C09_İfElsİfStatementsOnemliiiiiTekrarrr {
    public static void main(String[] args) {
        ...
        if ( kilo<20 || kilo>200 || boy<30 || boy> 200|| vke<10 || vke>50){
            ...
            System.out.println("Vucut kitle indeksiniz:" + vke +"Sonuc: Obez");

        } else if (vke>25) {
            System.out.println("Vucut kitle indeksiniz:" + vke +"Sonuc: Kilolusunuz");

        } else if (vke>20) {
            System.out.println("Vucut kitle indeksiniz:" + vke +"Sonuc: Kilonuz normal sinirlar icinde");

        }else {

            System.out.println("Vucut kitle indeksiniz:" + vke +"Sonuc: Zayifsiniz");
        }
